...
if("crop_expansion" %in% hyp_lib ){ hyp_lib = c(hyp_lib, "crop_cover") }
if("crop_expansion" %in% hyp_strict ){ hyp_strict = c(hyp_strict, "crop_cover") }
hyp_lib = unique(c(hyp_lib, confound, hyp_strict)); hyp_lib = hyp_lib[ hyp_lib != "" ]
