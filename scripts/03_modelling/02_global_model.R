...
# 
# # ===================== Main transmission schema ====================
# 
# # 1. zoonotic and vector borne
# 
# mzvb_nonspatial1 = fitGlobalModel(data=dd[ dd$ZVB == 1, ], 
#                                 study_shp=zvb_studyarea, 
#                                 predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                                 type="Nonspatial_nondetection", 
#                                 mesh_edge=2.5, prange=20, psigma=10, fit_spde = FALSE)
# save(mzvb_nonspatial1, file="./output/model_outputs/global_models/global_m1_nonspatial_zvb.R")
# 
# mzvb_spatial1 = fitGlobalModel(data=dd[ dd$ZVB == 1, ], 
#                              study_shp=zvb_studyarea, 
#                              predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                              type="Spatial_nondetection", 
#                              mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mzvb_spatial1, file="./output/model_outputs/global_models/global_m2_spatial_zvb.R")
# 
# mzvb_spatial2 = fitGlobalModel(data=dd[ dd$ZVB == 1, ], 
#                              study_shp=zvb_studyarea, 
#                              predictors=preds_m,
#                              type="Spatial_detection", 
#                              mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mzvb_spatial2, file="./output/model_outputs/global_models/global_m3_spatial_zvb.R")
# 
# 
# 
# # 2. zoonotic direct
# 
# mz_nonspatial1 = fitGlobalModel(data=dd[ dd$Z == 1, ], 
#                                   study_shp=z_studyarea, 
#                                   predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                                   type="Nonspatial_nondetection", 
#                                   mesh_edge=2.5, prange=20, psigma=10, fit_spde = FALSE)
# save(mz_nonspatial1, file="./output/model_outputs/global_models/global_m1_nonspatial_z.R")
# 
# mz_spatial1 = fitGlobalModel(data=dd[ dd$Z == 1, ], 
#                                study_shp=z_studyarea, 
#                                predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                                type="Spatial_nondetection", 
#                                mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mz_spatial1, file="./output/model_outputs/global_models/global_m2_spatial_z.R")
# 
# mz_spatial2 = fitGlobalModel(data=dd[ dd$Z == 1, ], 
#                                study_shp=z_studyarea, 
#                                predictors=preds_m,
#                                type="Spatial_detection", 
#                                mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mz_spatial2, file="./output/model_outputs/global_models/global_m3_spatial_z.R")
# 
# 
# 
# # 3. vector borne only (principally HH)
# 
# mvb_nonspatial1 = fitGlobalModel(data=dd[ dd$VB == 1, ], 
#                                 study_shp=vb_studyarea, 
#                                 predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                                 type="Nonspatial_nondetection", 
#                                 mesh_edge=2.5, prange=20, psigma=10, fit_spde = FALSE)
# save(mvb_nonspatial1, file="./output/model_outputs/global_models/global_m1_nonspatial_vbo.R")
# 
# mvb_spatial1 = fitGlobalModel(data=dd[ dd$VB == 1, ], 
#                              study_shp=vb_studyarea, 
#                              predictors=preds_m[ !preds_m %in% c("health_travel_log", "urban_cover")],
#                              type="Spatial_nondetection", 
#                              mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mvb_spatial1, file="./output/model_outputs/global_models/global_m2_spatial_vbo.R")
# 
# mvb_spatial2 = fitGlobalModel(data=dd[ dd$VB == 1, ], 
#                              study_shp=vb_studyarea, 
#                              predictors=preds_m,
#                              type="Spatial_detection", 
#                              mesh_edge=2.5, prange=20, psigma=10, fit_spde = TRUE)
# save(mvb_spatial2, file="./output/model_outputs/global_models/global_m3_spatial_vbo.R")
# 
