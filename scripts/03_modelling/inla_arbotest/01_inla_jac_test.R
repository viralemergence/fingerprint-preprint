...
dz = read.csv("C:/Users/roryj/Documents/Research/projects_current/202011_fingerprint/arbonet/fingerprint_formatted/spillovers_arbonet.csv") %>%
  dplyr::filter(Disease == "Jamestown Canyon virus disease" & Presentation == "All cases") %>%
...
hyp_strict = hyp_strict[ ! hyp_strict %in% c("urban_expansion", "tmean_change", "health_travel_log") ]
...
save(m1, file="./output/model_outputs/wnv_testmodels/jac_spde_mod1.R")
...
save(m2, file="./output/model_outputs/wnv_testmodels/jac_spde_mod2.R")
...
load(file="./output/model_outputs/wnv_testmodels/jac_spde_mod1.R")
load(file="./output/model_outputs/wnv_testmodels/jac_spde_mod2.R")
