...
# ================ EASTERN EQUINE ENCEPHALITIS (USA) ===================
...
dz = read.csv("C:/Users/roryj/Documents/Research/projects_current/202011_fingerprint/arbonet/fingerprint_formatted/spillovers_arbonet.csv") %>%
  dplyr::filter(Disease == "Eastern equine encephalitis" & Presentation == "All cases") %>%
...
# either travel time to healthcare or urban
mc_vars_to_exclude = c("urban_expansion", "social_vulnerability", "health_travel_log", "biodiv_intact", "crop_cover")
