...
dd = read.csv(filename) %>%
  dplyr::select(-health_travel_log,-livestock_all, -evi_coefvar, -tmean_anomaly, -precip_anomaly)
...
mc_vars_to_exclude = c("urban_expansion", "social_vulnerability", "health_travel")
